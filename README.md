# Luxury Hair — catálogo actualizado

Esta versión incluye:

- Logo oficial de Luxury Hair en encabezado, portada y pie.
- Fotografías nuevas asignadas al producto correcto.
- Todas las imágenes estandarizadas a 1200 × 1200 px.
- Imágenes completas, sin recortes en las tarjetas ni en la ventana de información.
